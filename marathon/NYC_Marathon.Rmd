...
1. In terms of location, __we find that athletes mostly come from the US (over 70%) and the rest are international__. On the right hand side we see the top ten states in the left the top ten countries. We were not surprised to see NJ and CA in the top (the former due to geographical closeness and latter for the well-known healthy trend). Yet, we were surprised to see that Italy and France were so represented. In terms of age and gender, __we found that the majority of the participants are young adults around 40 years old and that, on average, female athletes tend to be younger__. Also, we say that as age increases the number of female participants decreases. 
...
2. We found that the gender ratio is generally low and that only 3 countries are above 0.8 (women / men). Nonetheless, in the majority of the US states have an above 1 ratio. Please see section [XXX] for the full decomposition of each graph.
...
3. We found that the difference in performance between women and men is only observed in groups that rely on more capacity (for full details see section XXX).
