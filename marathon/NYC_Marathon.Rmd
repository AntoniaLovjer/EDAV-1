...
We can further examine the importance of country amongst the runners by looking at where the top runners come from. The US has had the most top runners in 2018. This result is expected since a large majority of the participants are coming from the US. What is surprising, however, is that countries such that are very lightly represented such as Uganda and Kenya end up having a significant portion of their runners finishing in the top.
...
For the interactive component, we decided to generate a dashboard that could let us summarize the information for each location (states or countries), and compare some results with the overall, across the four years of marathon data we collected. We belive that summarizing data in a graphical way
