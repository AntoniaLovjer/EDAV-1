...
def get_runner_info(bib):
    # Id
    marathon_url = 'https://results.nyrr.org/runner/{bib}/result/M2016'.format(bib=bib)
    runner = dict()
...
if __name__ == "__main__":
    ...
    year = 2016
    filename = 'marathon_{year}.csv'.format(year=year)
    bib_start = 0
    bib_end = bib_start + 100
    # Loop
    total = 75000

    while bib_start < total:
        res = Parallel(n_jobs=10)(delayed(get_runner_info)(bib)
